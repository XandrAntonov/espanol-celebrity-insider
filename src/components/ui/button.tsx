  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        cta: "bg-gradient-cta text-white hover:shadow-glow transform hover:scale-105 font-semibold transition-bounce animate-pulse-glow",
        hero: "bg-gradient-hero text-white hover:shadow-elegant transform hover:scale-105 font-bold transition-bounce border border-primary-glow/30",
        elegant: "bg-card text-card-foreground border border-border hover:shadow-card hover:border-primary/30 transition-smooth",
      },
      size: {
